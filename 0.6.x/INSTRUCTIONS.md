# V Rising Dedicated Server Instructions for v0.6.x

> [!NOTE]
> These instructions are for the Gloomrot version (`0.6.x`) of the V Rising Dedicated Server.  
>
...
This version of the V Rising Dedicated server can be downloaded from the `legacy-0.6.x` branch.
